...
class TestPathValidatorValidatePath:
    ...
    def test_validate_existing_file(self, tmp_path: Path) -> None:
        ...
        result = PathValidator.validate_path(test_file, must_exist=True, must_be_file=True, must_be_readable=True)
    ...
    def test_validate_with_base_directory(self, tmp_path: Path) -> None:
        ...
        result = PathValidator.validate_path(relative_path, base_directory=base_dir, must_exist=True)
        assert result == test_file.resolve()
    ...
    def test_validate_absolute_path_with_base_directory(self, tmp_path: Path) -> None:
        ...
        result = PathValidator.validate_path(test_file, base_directory=base_dir, must_exist=True)
        assert result == test_file.resolve()
