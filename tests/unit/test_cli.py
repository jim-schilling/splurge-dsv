...
from splurge_dsv.cli import parse_arguments, print_results, main
...
class TestCliParseArguments:
    ...
    def test_parse_arguments_with_options(self) -> None:
        ...
        with patch.object(sys, 'argv', [
            'script', 'test.tsv', '--delimiter', '\t', '--encoding', 'latin-1',
            '--skip-header', '2', '--skip-footer', '1', '--stream', '--chunk-size', '100'
        ]):
            args = parse_arguments()
